...
static const flex_int16_t yy_base[25] =
    {   0,
        0,    0,   28,   29,   25,    0,    0,   21,   18,    4,
        5,   22,    0,   18,   29,   15,   14,    0,    0,   13,
       11,   29,   13,   16
    } ;

static const flex_int16_t yy_def[25] =
    {   0,
       22,    1,   22,   22,   22,   23,   23,   24,   22,   22,
       22,   22,   23,   24,   22,   22,   22,   10,   11,   22,
       22,    0,   22,   22
    } ;

static const flex_int16_t yy_nxt[39] =
    {   0,
        4,    5,    6,    7,    8,    9,   10,   11,   11,   17,
       18,   19,   19,   19,   13,   13,   14,   20,   14,   20,
       21,   20,   15,   12,   16,   15,   12,   22,    3,   22,
...
static const flex_int16_t yy_chk[39] =
    {   0,
       ...
       10,   11,   11,   11,   23,   23,   24,   21,   24,   20,
       17,   16,   14,   12,    9,    8,    5,    3,   22,   22,
       22,   22,   22,   22,   22,   22,   22,   22
    } ;
